...
.left-panel { border: 1px solid #333; background: #111; padding: 12px; display: flex; flex-direction: column; gap: 8px; overflow: hidden; max-height: 100%; }
.right-panel { border: 1px solid #333; background: #111; padding: 12px; overflow: hidden; max-height: 100%; display: flex; flex-direction: column; }
.menu-list { display: flex; flex-direction: column; gap: 8px; }
.window { display: flex; flex-direction: column; gap: 8px; padding: 8px; border: 1px solid #333; background: #0c0c0c; }
.level-window { display: flex; flex-direction: column; gap: 12px; border: 1px solid #333; background: #0c0c0c; padding: 8px; max-height: 100%; overflow-y: auto; flex: 1; min-height: 0; }
...
.description { border: 1px solid #333; background: #0c0c0c; min-height: 120px; padding: 8px; overflow-y: auto; flex: 1; }
